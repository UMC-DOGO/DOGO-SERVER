module.exports = function (app) {
  ...
  // 7. 후기 공감 취소
  app.patch(
    "/app/walk/reviews/decreasedinterest/:reviewId",
    walk.patchReviewMinus
  );

  // 8. 피드백 공감
  app.patch(
    "/app/walk/feedbacks/addedinterest/:feedbackId",
    walk.patchFeedbackPlus
  );

  //9. 피드백 공감 취소
  app.patch(
    "/app/walk/feedbacks/decreasedinterest/:feedbackId",
    walk.patchReviewMinus
  );
  ...
  // 15. 피드백 공감 개수 조회
  app.get(
    "/app/walk/feedbacks/interests/:feedbackId",
    walk.getFeedbackInterest
  );
