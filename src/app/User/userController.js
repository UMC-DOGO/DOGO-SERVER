...
exports.patchUsers = async function (req, res) {
  ...
  console.log("userController:", req.verifiedToken);
  const userId = req.params.userId;
...
exports.getRecomment = async function (req, res) {
  ...
  const PostReommentList = await userProvider.retrievePostRecommList(
    postId,
    commentId
  );
...
exports.deleteRecomment = async function (req, res) {
  ...
  const deleteRecommentInfo = await userService.deleteRecomment(
    postId,
    commentId,
    replyId
  );
